        ...
        <div class="media py-1">
          ...
          <div class="media-body">
            <div class="row">
              <div class="col-md-8">
                <router-link
                  :to="{name: 'user', params: { identifier: publicIdentifier(post) }}"
              ...
              <div class="col-md-4">
                <div v-if="isReady && postBelongsToAuthUser" class="dropdown text-right">
                  <a
                    href="#"
